  ...
  let editModalClose=()=>this.setState({editModalShow:false});
    return (
      <div className="deputetetContent">
        ...
        <input type="text" id="inputi" name="emri_shtetet" class="form-content2" placeholder="Emri i Shtetit..."></input>
              ...
              {shtet.map((shte) => (
                <tr key={shte.shtetet_id}>
                  ...
                  <ButtonToolbar className="butonat">
                      ...
                      <Button className="editButon"onClick={()=>this.deleteShtetin(shte.shtetet_id)}>
            Fshij
          </Button>
                      <EditShtetModal

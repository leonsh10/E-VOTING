        ...
        return(
            <div class="componentsHome">
                <div class="homeContent">
                    ...
                    <button class="home-btn" onClick={handleScroll}>SI TE VOTONI</button>
            ...
            /> */}
                ...
                <h1>Si te votoni?</h1>
                <p>Qe te kryeni votimin me sukses ne kemi pergatitur nje video tutorial ku tregojme hap pas hapi se si duhet te votoni.Per qdo paqartesi klikoni butonin me poshte qe te kontaktoni me ne.</p>
